...
public class QLambdaLearner extends QLearner {
    ...
    @Override
    public void update(final int currentStateId, final int currentActionId, final int nextStateId, final Set<Integer> actionsAtNextStateId, final double immediateReward) {
